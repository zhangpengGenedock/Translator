...
if __name__ == '__main__':
    with open('../stf_data/train_seg.en') as f1, open('../stf_data/train_ctb_seg.zh') as f2, open(
            '../stf_data/train_split.en', 'w') as f3, open('../stf_data/train_split.zh', 'w') as f4, open(
            '../stf_data/dev_split.en', 'w') as f5, open('../stf_data/dev_split.zh', 'w') as f6:
        ...
        f6.writelines(["%s" % item for item in y_test])
